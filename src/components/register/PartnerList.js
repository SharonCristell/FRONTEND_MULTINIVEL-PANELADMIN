...
import '../../views/styles/SearchStyle.css';
                                            ...
                                            return (
                                                ...
                                                <tr key={idx}>
                                                    ...
                                                    <td>{item.descriptionPendingFee}</td>
                                                     <td>{Validation.convertDate(new Date(item.datePendingFee))}</td>
                                                    <td>{item.pendingFee} USD</td>
                                                   <td>{Validation.convertDate(new Date(item.lastDatePaidFee))}</td>
                                                </tr>
                                            )
                                        })
                                    }
