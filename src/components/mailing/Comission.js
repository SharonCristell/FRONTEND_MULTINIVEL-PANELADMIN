...
export default class Comission extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            schedulee: [
                {
                    idmembershipdetail: 1,
                    descripcion: "cuota",
                    initialDate: "2020-05-25T00:00:00",
                    capitalBalance: "DN44755190",
                    amortization: "diana Carolina",
                    interested: "Ninasivincha Quispe",
                    quote: "carolinaninasivincha16@gmail.com",
                    obs: "+51935279874",
                    score: "44755190",
                    nroOperacion: "Santos Leòn Merma",
                    accountHolder: 303,
                    status: 21,
                    //isChecked: false,
                },
                {
                    idmembershipdetail: 2,
                    descripcion: "cuota",
                    initialDate: "2020-05-25T00:00:00",
                    capitalBalance: "DN44755190",
                    amortization: "diana Carolina",
    ...
    render() {
        const { pendingList, message2, loadModal } = this.state;
                        ...
                        <Row>
                            ...
                            <Col sm={12}>
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            ...
                                            <Form.Label className="content-subtitle">Nombre Completo:</Form.Label>
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            <Form.Label className="content-subtitle">Correo Electrónico:</Form.Label>
                            ...
                            <Col sm={12}>
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            <Form.Check inline label="Correo Documentos" type='radio' id={`inline-radio`} value="CD"
                                                onChange={e => this.handleRadio(e, "packageStatus")}
                                                checked={this.state.packageStatus === "CD"} />
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            <Form.Check inline label="Correo Subir Recibo" type='radio' id={`inline-radio2`} value="CR"
                                                onChange={e => this.handleRadio(e, "packageStatus")}
                                                checked={this.state.packageStatus === "CR"} />
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            <Form.Check inline label="Cuota Faltante" type='radio' id={`inline-radio2`} value="CR"
                                                onChange={e => this.handleRadio(e, "packageStatus")}
                                                checked={this.state.packageStatus === "CR"} />
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <Form.Group>
                                            <Form.Check inline label="Pago Exitoso" type='radio' id={`inline-radio2`} value="CR"
                                                onChange={e => this.handleRadio(e, "packageStatus")}
                                                checked={this.state.packageStatus === "CR"} />
